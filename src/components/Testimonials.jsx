                    ...
                    loading ? <div className='flex max-w-full justify-center min-h-[65vh]'><Loader /> </div> :
                        <div className="flex flex-wrap mx-auto justify-center max-w-[100vw] ">
                            ...
                            >
                                ...
                                {
                                    isAuthenticated ? <button className='bg-white hover:bg-gray-900 px-6 rounded-sm py-2 mb-4 hover:text-white  ml-8 ' onClick={handleReview}>Add Review</button> : <button className='bg-white px-6 rounded-sm py-2 mb-4 md:mb-2 hover:bg-gray-500 ml-8'>
