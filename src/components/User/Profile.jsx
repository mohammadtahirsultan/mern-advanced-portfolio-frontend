...
const Profile = () => {
    ...
    return (
        <div
            className="max-w-2xl mx-4 sm:max-w-sm md:max-w-2xl lg:max-w-2xl xl:max-w-4xl sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto h-[50vh] md:h-[65vh] mt-16 bg-white shadow-xl rounded-lg text-gray-900">
