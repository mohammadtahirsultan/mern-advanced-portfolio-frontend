    ...
    return (
        <footer className="body-font">
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className={`text-sm  sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4`}>© {new Date().getFullYear()} Ghareeb Star Programmer —
                    <a href="mailto:tahirsultanofficial@gmail.com" className={`ml-1`} rel="noopener noreferrer" target="blank">@tahirsultanofficial</a>
                </p>
